...
def get_number_of_bills(amount, denomination):
    ...
    return int((amount-get_leftover_of_bills(amount,denomination)) / denomination)
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    return int((budget/(exchange_rate*(1+(spread/100))))-(budget/(exchange_rate*(1+(spread/100)))%denomination))
